...
import {
  ...
  Calendar, BookOpen, Cpu as CpuIcon, Heart, Star, Package, BarChart3,
} from "lucide-react";
  ...
  {headlines[hIdx]}
        ...
        <motion.div initial={{ opacity:0, y:18 }} animate={{ opacity:1, y:0 }} transition={{ duration:.72, delay:.62 }}
          ...
          <Link to="/results/intermediate">
            <MagBtn className="group relative px-9 py-4 border-2 border-[#D4AF37]/50 text-[#D4AF37] rounded-full font-bold text-sm bg-white/80 hover:bg-[#FFF4ED] overflow-hidden shadow-lg shadow-[#D4AF37]/20 transition-all">
              <span className="relative z-10 flex items-center justify-center gap-2">
                View Results
                <BarChart3 className="w-4 h-4" />
              </span>
              <motion.div className="absolute inset-0 bg-[#D4AF37] rounded-full origin-center" initial={{ scale:0 }} whileHover={{ scale:3 }} transition={{ duration:.5 }} />
            </MagBtn>
          </Link>
          <button
