...
function HeroSection({ jobCount, onScrollToOpenings }) {
  ...
  return (
    <section id="career-hero" className="relative pt-32 pb-20 px-4 sm:px-6 overflow-hidden min-h-screen flex items-center">
      {/* Background image */}
      ...
      <div className="max-w-6xl mx-auto pb-24 text-center relative z-10">
        ...
        >
          ...
          <span className="relative inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-[#F04A06]/20 to-[#C5531A]/20 text-[#F04A06] rounded-full text-sm font-semibold border border-[#F04A06]/30 backdrop-blur-sm shadow-lg shadow-[#F04A06]/10">
        ...
        >
          <motion.button
            whileHover={{ scale: 1.05, boxShadow: "0 20px 60px rgba(240,74,6,0.4)" }}
            whileTap={{ scale: 0.95 }}
          ...
          <Link to="/about">
            <motion.button whileHover={{ scale: 1.05, backgroundColor: "rgba(230,107,38,0.07)" }} whileTap={{ scale: 0.96 }}
              ...
              >
                ...
                <Float duration={4+i*.4} delay={i*.3}>
                  <div className="relative inline-block">
                    <div className="w-16 h-16 rounded-full bg-[#FFF4ED] border border-[#D4AF37]/30 flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
                ...
                <div className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-[#D4AF37] to-[#F04A06] opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {BENEFITS_DATA.map((b, i) => (
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.5, delay: i * 0.1 }}
              whileHover={{ y: -8, boxShadow: "0 24px 55px rgba(0,0,0,0.10)" }}
              className="group relative bg-white p-6 rounded-2xl border border-gray-200 hover:border-[#D4AF37] transition-all overflow-hidden"
            >
              ...
              <div className="relative z-10 flex items-start gap-4">
                <Float duration={4+i*.5} delay={i*.3}>
                  <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${b.gradient} p-0.5 flex-shrink-0`}>
                    <div className="w-full h-full rounded-xl bg-white flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {filtered.map((job, i) => (
              <motion.div
                ...
                whileHover={{ y: -6, boxShadow: "0 24px 55px rgba(0,0,0,0.10)" }}
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <motion.button onClick={() => onApply(job.title)} whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}
        ...
        <div className="max-w-4xl mx-auto relative z-10 text-center">
          ...
          >
            <div className="bg-white p-12 rounded-3xl border border-gray-200 shadow-xl relative overflow-hidden">
              <div className="absolute -inset-1 bg-gradient-to-r from-[#D4AF37]/0 via-[#D4AF37]/10 to-[#D4AF37]/0 animate-light-sweep" />
              <motion.div animate={{ rotate: [0, 10, -10, 0], scale: [1, 1.1, 1] }} transition={{ duration: 3, repeat: Infinity }}>
                <SparklesIcon className="w-16 h-16 text-[#D4AF37] mx-auto mb-6" />
              </motion.div>
              <h2 className="text-3xl md:text-4xl font-bold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-[#F04A06] to-[#F04A06]">
            ...
            >
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-4 mb-4">
                  <Float duration={4+i*.5} delay={i*.3}>
                    <div className="w-12 h-12 rounded-full bg-[#FFF4ED] border border-[#D4AF37]/30 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                ...
                <div className="mt-4 flex text-[#D4AF37]">
                  {[...Array(5)].map((_, j) => (
                    <motion.div key={j} animate={{ scale: [1, 1.3, 1] }} transition={{ duration: 2, repeat: Infinity, delay: j * 0.15 }}>
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={hasOpenings ? onBrowse : onSendResume}
              className="w-full sm:w-auto px-8 py-4 border-2 border-white text-white rounded-full font-semibold hover:bg-white hover:text-[#F04A06] transition-all flex items-center justify-center gap-2"
            >
            ...
            <Link to="/contact" className="w-full sm:w-auto">
              <motion.button whileHover={{ scale: 1.05, backgroundColor: "rgba(255,255,255,0.14)" }} whileTap={{ scale: 0.95 }}
                className="w-full sm:w-auto px-8 py-4 border-2 border-white/60 text-white rounded-full font-semibold hover:border-white transition-all flex items-center justify-center gap-2"
              >
                Get in Touch
